 ...
 *   آبل باي حُذفت نهائياً (قرار المالك 2026-08-02)
...
/** شعار «G» الرسمي متعدد الألوان — ألوان قوقل المعتمدة في علامة G Pay (ألوان علامة خارجية لا تخضع لـtokens) */
...
/** علامة «G Pay» الرسمية — شعار G الملون + Pay، في الشارة البيضاء المعتمدة */
function GPayMark() {
  return (
...
export default function CheckoutPage() {
  ...
  const payAndOrder = async (walletTokens?: {
    ...
    try {
      ...
      createdOrder = order;
      // مفتاح ثابت لهذا الطلب: إعادة المحاولة تُرجع النية نفسها بدل «intent موجود»
      intentKey.current ??= `pi-${order.id}`;
