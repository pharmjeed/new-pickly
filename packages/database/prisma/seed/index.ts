...
async function seedSystemDefaults() {
  ...
  const settings: Array<[string, unknown]> = [
    ...
    // تصنيفات المطاعم C-09 — يديرها السوبر أدمن (إضافة/حذف/ترتيب/تفعيل/صورة)
    // القائمة المعتمدة من المالك 2026-07-15 بترتيب لوحة النماذج (أيقونات public/cats في customer-web)
    [
      "cms.categories",
      [
        { name_ar: "برجر", is_active: true, image_url: "/cats/burger.jpg" },
        { name_ar: "دجاج", is_active: true, image_url: "/cats/chicken.jpg" },
        { name_ar: "مندي ومظبي", is_active: true, image_url: "/cats/mandi.jpg" },
        { name_ar: "بيتزا", is_active: true, image_url: "/cats/pizza.jpg" },
        { name_ar: "ساندوتشات", is_active: true, image_url: "/cats/sandwich.jpg" },
        { name_ar: "سوشي", is_active: true, image_url: "/cats/sushi.jpg" },
        { name_ar: "باستا", is_active: true, image_url: "/cats/pasta.jpg" },
        { name_ar: "سلطات", is_active: true, image_url: "/cats/salad.jpg" },
        { name_ar: "مقبلات", is_active: true, image_url: "/cats/appetizers.jpg" },
        { name_ar: "بطاطس", is_active: true, image_url: "/cats/fries.jpg" },
        { name_ar: "راب", is_active: true, image_url: "/cats/wrap.jpg" },
        { name_ar: "بحري", is_active: true, image_url: "/cats/seafood.jpg" },
        { name_ar: "حلويات", is_active: true, image_url: "/cats/dessert.jpg" },
        { name_ar: "مشروبات", is_active: true, image_url: "/cats/drinks.jpg" },
        { name_ar: "عصائر طازجة", is_active: true, image_url: "/cats/juice.jpg" },
        { name_ar: "مشروبات ساخنة", is_active: true, image_url: "/cats/hotdrinks.jpg" },
        { name_ar: "فطور", is_active: true, image_url: "/cats/breakfast.jpg" },
        { name_ar: "وجبات أطفال", is_active: true, image_url: "/cats/kids.jpg" }
      ]
    ],
...
async function seedMerchant(spec: {
  ...
  for (const b of spec.branches) {
    ...
    // أسماء دخول قصيرة بلا شرطات: الدور + رقم الفرع (مثل cashier101)
    const staffSpecs: Array<[string, string, string]> = [
      ["branch_manager", `manager${b.code}`, "مدير الفرع"],
      ["cashier", `cashier${b.code}`, "الكاشير"],
      ["kitchen", `kitchen${b.code}`, "المطبخ"],
      ["handoff", `handoff${b.code}`, "راشد (تسليم)"]
    ];
...
async function main() {
  ...
  await seedMerchant({
    ...
    branches: [
      { name: "بيست برجر — العليا", code: "101", city: "الرياض", address: "شارع العليا العام", lat: 24.6949, lng: 46.6853, spots: ["1", "2", "3", "4", "أمام المدخل"] },
      { name: "بيست برجر — النخيل", code: "102", city: "الرياض", address: "طريق الملك سلمان، النخيل", lat: 24.7565, lng: 46.6288, spots: ["1", "2", "3"] },
      { name: "بيست برجر — قباء", code: "103", city: "المدينة المنورة", address: "طريق قباء", lat: 24.4410, lng: 39.6180, spots: ["1", "2", "3", "أمام المدخل"] }
    ],
    menu: [
      {
        category: "برجر",
  ...
  await seedMerchant({
    ...
    branches: [
      { name: "الديوان — الملز", code: "201", city: "الرياض", address: "شارع الستين، الملز", lat: 24.6664, lng: 46.7398, spots: ["1", "2", "أمام المدخل"] },
      { name: "الديوان — الحمراء", code: "202", city: "جدة", address: "طريق الأمير سلطان، الحمراء", lat: 21.5433, lng: 39.1728, spots: ["1", "2", "3", "4"] },
      { name: "الديوان — العزيزية", code: "203", city: "المدينة المنورة", address: "شارع العزيزية", lat: 24.4555, lng: 39.6320, spots: ["1", "2", "3", "أمام المدخل"] }
    ],
    menu: [
      {
        category: "شاورما",
  ...
  await seedMerchant({
    ...
    branches: [
      { name: "سحابة — حطين", code: "301", city: "الرياض", address: "بوليفارد حطين", lat: 24.7748, lng: 46.5987, spots: ["1", "2", "3"] },
      { name: "سحابة — الشاطئ", code: "302", city: "الدمام", address: "كورنيش الشاطئ الغربي", lat: 26.4498, lng: 50.0891, spots: ["1", "2"] },
      { name: "سحابة — سلطانة", code: "303", city: "المدينة المنورة", address: "شارع سلطانة", lat: 24.4760, lng: 39.5900, spots: ["1", "2", "أمام المدخل"] }
    ],
    menu: [
      {
        category: "قهوة ساخنة",
