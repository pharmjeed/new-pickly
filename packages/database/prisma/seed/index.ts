...
async function seedSystemDefaults() {
  ...
  const templates: Array<[string, string, string]> = [
    ...
    ["order_accepted", "قبل المطعم طلبك", "الوقت المتوقع للتجهيز {{prep_minutes}} دقيقة — وافق وادفع خلال 5 دقائق ليبدأ التجهيز"],
    ["order_preparing", "تم الدفع وبدأ التجهيز", "طلبك {{display_code}} قيد التجهيز الآن — انطلق بحسب الوقت المتفق"],
    ["order_expired_unconfirmed", "انتهت مهلة الموافقة", "ما وصلنا ردك على وقت تجهيز طلبك {{display_code}} — أعد الطلب متى شئت، ولم يُدفع أي مبلغ"],
    ["order_expired_unpaid", "انتهت مهلة الدفع", "ما اكتمل دفع طلبك {{display_code}} خلال المهلة — أعد الطلب متى شئت، ولم يُدفع أي مبلغ"],
    ["order_rejected", "نعتذر — ما قدر المطعم يستقبل طلبك", "لم يُدفع أي مبلغ — أعد الطلب من مطعم آخر متى شئت"],
