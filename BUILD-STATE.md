...
- المرحلة 3 (المتبقي): تطبيق Expo/RN للعميل (P1 التهيئة + P2–P8 native + Live Activity لاحقاً) —
  الويب الحالي يغطي J4 (رحلة الويب كاملة) وW-track ضمناً عبر /track.
- المرحلة 4: بوابة التاجر merchant-web (14 صفحة) + B-02/B-16 الوردية + B-07/08 KDS + B-15 الازدحام.
- تقييم P8 (Sheet فوق شاشة الاكتمال في /track) — الـAPI جاهز، الواجهة لم تُوصل بعد.
- ملاحظات: mock gateway في ذاكرة عملية الـAPI · Playwright يُضاف لركن CI مستقل (مرحلة 8).
