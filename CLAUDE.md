...
- **ممنوع بناء:** أي شيء متعلق بمناديب/توصيل، طلب من الطاولة، حجوزات، ولاء ضخم، ALPR، Microservices، Kubernetes، تعدد دول/عملات. (محفظة بيكلي الداخلية دخلت النطاق بقرار المالك 2026-07-12 — docs/01§1؛ شحنها الخارجي ينتظر مفاتيح B1.)
